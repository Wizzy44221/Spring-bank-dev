...
//            String otp = otpService.generateOtp(userToCredit.getEmail());
//
//
//            EmailDetails creditAlert = EmailDetails.builder()
//                .subject("OTP for transaction verification")
//                .recipient(userToCredit.getEmail())
//                .messageBody("Your OTP for the transaction of " + request.getAmount() + " is: " + otp)
//                .build();
//
//        emailService.sendEmailAlert(creditAlert);
//
...
//        }
//
//        return completedCreditTransaction(userToCredit, request);
//
//    }
//
//    public BankResponse verifyOtpAndCompleteTransaction(CreditAndDebitRequest request, String otp){
//        UserEntity userToCredit = userRepository.findByAccountNumber(request.getAccountNumber());
//
//        boolean isOtpValid = otpService.validateOpt(userToCredit.getEmail(), otp);
//
//        if(!isOtpValid){
//            return BankResponse.builder()
//                    .responseCode("010")
...
//
//
//    private BankResponse completedCreditTransaction(UserEntity userToCredit,
//                                                    CreditAndDebitRequest request) {
//
//        userToCredit.setAccountBalance(userToCredit.getAccountBalance().add(request.getAmount()));
